...
class LivreController extends AbstractController
{
    ...
    public function show_livre(int $id, LivreRepository $livreRepository): Response
    {
    ...
    public function addLivre(Request $request, ManagerRegistry $managerRegistry): Response
    {
        ...
        if ($data!=null) {
            ...
            $livre->setDateParution(date_create($data['dateParution']));
    ...
    public function update(Request $request, ManagerRegistry $managerRegistry, int $id)
    {
        $entityManager = $managerRegistry->getManager();
    ...
    public function delete(int $id, ManagerRegistry $managerRegistry)
    {
        $entityManager = $managerRegistry->getManager();
        $livre = $entityManager->getRepository(Livre::class)->find($id);
